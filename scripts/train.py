...
from utils import get_device, preprocess_text, KnowledgeGraphDataset
...
def main(data_path):
    ...
    # DataLoader
    train_dataset = KnowledgeGraphDataset(train_encodings, train_labels.tolist())
    val_dataset = KnowledgeGraphDataset(val_encodings, val_labels.tolist())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, required=True, help='Path to the CSV file containing knowledge graph data')
